...
//Первый файл – это интерфейс ISearcher, который задает контракт поиска: 
...
public interface ISearcher {
	 ...
	 * 
	 * @param classNames
	 *            названия классов в проекте
	 * @param modificationDates
	 *            дата модификации класса в формате мс, прошедших с 1 января
	 *            1970 года
	 */
	public void refresh(String[] classNames, long[] modificationDates);

	/**
	 * Ищет подходящие имена классов Название должно начинаться с start
	 * 
	 * @param start
	 *            начало имени класса
